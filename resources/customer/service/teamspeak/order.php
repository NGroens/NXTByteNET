                ...
                <div class="card card-shadow">
                    <div class="card-header card-header-transparent py-20 text-center">
                        ...
                        <?php if($orderSuccess){ ?>
                            ...
                            <script>
                                var messages = {
                                    ...
                                    0: 'Dein Teamspeak 3 Server ist nun vollständig eingerichtet.'
                                };
                                timer = 5;
                                function countdown() {
                        ...
                        <?php } else { ?>
                            ...
                            <form method="post">
                                <label>Slots</label>
                                <input name="slot_count" id="slot_count" class="form-control" type="number" value="10" min="10" max="1000">
...
<script type="text/javascript">
    ...
    function update()
    {
        var price = Number((parseInt($('#slot_count').val()) * <?php echo $site->getPriceFromProduct($odb, 'TEAMSPEAK'); ?>) * ($("#duration").find("option:selected").data("factor") / 30)).toLocaleString("de-DE", {minimumFractionDigits: 2, maximumFractionDigits: 2});
